...
struct reg_acc_blk_cfg timpani_blkcfg[RA_BLOCK_NUM] = {
    {
        .valid_owners = {
            RA_OWNER_NONE, RA_OWNER_PATH_RX1,
    ...
    {
        .valid_owners = {
            RA_OWNER_NONE, 0, RA_OWNER_PATH_RX2,
            0, 0, 0, RA_OWNER_DRV
        }
    },
    /* RA_BLOCK_RX2 */
    {
        .valid_owners = {
            RA_OWNER_NONE, 0, 0, RA_OWNER_PATH_TX1,
            0, 0, RA_OWNER_DRV
        }
    },
    /* RA_BLOCK_TX1 */
    {
        .valid_owners = {
            RA_OWNER_NONE, 0, 0, 0, RA_OWNER_PATH_TX2,
            0, RA_OWNER_DRV
        }
    },
    /* RA_BLOCK_TX2 */
