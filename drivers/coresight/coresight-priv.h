...
#else
static inline bool coresight_fuse_access_disabled(void) {
    return false;
}
static inline bool coresight_fuse_apps_access_disabled(void) {
    return false;
}
#endif
...
#else
static inline unsigned int etm_readl_cp14(uint32_t off) {
    return 0;
}
