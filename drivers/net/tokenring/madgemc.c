...
static int __devinit madgemc_probe(struct device *device) {
    ...
    case 0:
        ...
        break;
    case 1:
        printk("Limited burst");
        break;
    case 2:
        printk("Delayed release");
        break;
    case 3:
        printk("Immediate release");
        break;
    }
...
static int madgemc_mcaproc(char *buf, int slot, void *d) {
    ...
    if (curcard) {
        ...
        case 0:
            len += sprintf(buf+len, "Cycle steal");
            break;
        case 1:
            len += sprintf(buf+len, "Limited burst");
            break;
        case 2:
            len += sprintf(buf+len, "Delayed release");
            break;
        case 3:
            len += sprintf(buf+len, "Immediate release");
            break;
        }
