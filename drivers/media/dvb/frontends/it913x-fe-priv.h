...
static struct it913xset it9135_38[] = {
    ...
    {
        PRO_DMOD, 0x0081, {
            0x0a, 0x12, 0x02, 0x0a, 0x03, 0xc8, 0xb8,
            0xd0, 0xc3, 0x01
        }, 0x0a
    },
    {PRO_DMOD, 0x008e, {0x01}, 0x01},
    ...
    {
        PRO_DMOD, 0x00fc, {
            0x02, 0x02, 0x02, 0x09, 0x50, 0x7b, 0x77,
    ...
    {
        PRO_DMOD, 0xf600, {
            0x05, 0x08, 0x0b, 0x0e, 0x11, 0x14, 0x17,
            0x1f
        }, 0x08
    },
...
static struct it913xset it9135_51[] = {
    ...
    {
        PRO_DMOD, 0x0081, {
            0x0a, 0x12, 0x02, 0x0a, 0x03, 0xc0, 0x96,
            0xcf, 0xc3, 0x01
        }, 0x0a
    },
    {PRO_DMOD, 0x008e, {0x01}, 0x01},
    ...
    {
        PRO_DMOD, 0x00fc, {
            0x03, 0x02, 0x02, 0x09, 0x50, 0x7a, 0x77,
...
static struct it913xset it9135_52[] = {
    ...
    {
        PRO_DMOD, 0x0081, {
            0x0a, 0x12, 0x03, 0x0a, 0x03, 0xb3, 0x97,
            0xc0, 0x9e, 0x01
        }, 0x0a
    },
    {PRO_DMOD, 0x008e, {0x01}, 0x01},
    ...
    {
        PRO_DMOD, 0x00fc, {
            0x03, 0x02, 0x02, 0x09, 0x50, 0x74, 0x77,
...
static struct it913xset it9135_60[] = {
    ...
    {
        PRO_DMOD, 0x00fc, {
            0x03, 0x03, 0x02, 0x0a, 0x50, 0x7b, 0x8c,
            0x00, 0x02, 0xbe, 0x00
        }, 0x0b
    },
    {PRO_DMOD, 0x0109, {0x02}, 0x01},
    ...
    {
        PRO_DMOD, 0x0141, {
            0x59, 0xf9, 0x19, 0x19, 0x8c, 0x8c, 0x8c,
...
static struct it913xset it9135_61[] = {
    ...
    {
        PRO_DMOD, 0x00fc, {
            0x03, 0x03, 0x02, 0x08, 0x50, 0x7b, 0x8c,
            0x01, 0x02, 0xc8, 0x00
        }, 0x0b
    },
    {PRO_DMOD, 0x0109, {0x02}, 0x01},
    ...
    {
        PRO_DMOD, 0x0141, {
            0x59, 0xf9, 0x59, 0x59, 0x8c, 0x8c, 0x8c,
...
static struct it913xset it9135_62[] = {
    ...
    {
        PRO_DMOD, 0x00fc, {
            0x02, 0x03, 0x02, 0x09, 0x50, 0x6e, 0x8c,
            0x02, 0x02, 0xc2, 0x00
        }, 0x0b
    },
    {PRO_DMOD, 0x0109, {0x02}, 0x01},
    ...
    {
        PRO_DMOD, 0x0141, {
            0x59, 0xf9, 0x59, 0x19, 0x8c, 0x8c, 0x8c,
