...
static inline int pxa910_add_uart(int id) {
    ...
    switch (id) {
    case 1:
        d = &pxa910_device_uart1;
        break;
    case 2:
        d = &pxa910_device_uart2;
        break;
    }
...
static inline int pxa910_add_twsi(int id, struct i2c_pxa_platform_data *data,
    ...
    switch (id) {
    case 0:
        d = &pxa910_device_twsi0;
        break;
    case 1:
        d = &pxa910_device_twsi1;
        break;
    default:
        return -EINVAL;
    }
...
static inline int pxa910_add_pwm(int id) {
    ...
    switch (id) {
    case 1:
        d = &pxa910_device_pwm1;
        break;
    case 2:
        d = &pxa910_device_pwm2;
        break;
    case 3:
        d = &pxa910_device_pwm3;
        break;
    case 4:
        d = &pxa910_device_pwm4;
        break;
    default:
        return -EINVAL;
    }
